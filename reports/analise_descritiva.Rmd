...
## Outra forma de ver os dados (staked dot plot)
...
Média: `r mean(elife$expectativa)`

Mediana: `r median(elife$expectativa)`
...
* Exemplo: A UFCG foi considerada a melhor instituição mais vezes do que as outras alternativas
...
<p align="center">
  <img width="65%" src="../data/img/media.png">
</p>
